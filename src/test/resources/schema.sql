...
ALTER TABLE user ADD CONSTRAINT phone_id_fk FOREIGN KEY (phone_id) REFERENCES phone (id);
...
ALTER TABLE event ADD CONSTRAINT address_id_event_fk FOREIGN KEY (address_id) REFERENCES address (id);
